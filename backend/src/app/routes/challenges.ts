...
router.post(
    ...
    function (request: Request, response: Response, next: NextFunction): void {
        ...
        challenges.getCurrentChallenge(request.body.year, request.body.week, (request.session as any).auth.user_id)
...
router.post(
    ...
    function (request: Request, response: Response, next: NextFunction): void {
        ...
        challenges.testChallenge((request.session as any).auth.user_id, request.body.id, request.body.solution)
        .then((res) => response.json(res), (err:any)=> next(err))      
    }
)
    // TODO - verify signedinuser
router.post(
    ...
    function (request: Request, response: Response, next: NextFunction): void {
        ...
        challenges.getChallengeHint((request.session as any).auth.user_id, request.body.id)
